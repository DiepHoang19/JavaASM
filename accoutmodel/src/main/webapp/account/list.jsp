...
<%@ page import="com.example.accoutmodel.entity.Account" %>
...
<div class="row">
    ...
    <div class="container">
        ...
        <div class="container text-left">
            ...
            <a href="<%=request.getContextPath()%>/account/create" class="btn btn-success">Add
                New Account</a>
        </div>
        <br>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary" href="/account/update?id=<%= account.getId() %>">Edit</a>
